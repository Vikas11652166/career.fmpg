...
export const uploadImage = async (fileInput, folder = 'job-images', fileName = null, retryCount = 0) => {
  try {
...
export const uploadFile = async (fileInput, folder = 'resumes', resourceType = 'raw', originalName = '', retryCount = 0) => {
  try {
    return new Promise((resolve, reject) => {
      const uploadOptions = {
...
export const uploadQuestionFile = async (fileBuffer, folder = 'question-files', fileName = null, originalName = '', mimeType = '', retryCount = 0) => {
  try {
    return new Promise((resolve, reject) => {
...
export const generateSignedUrl = (publicId, resourceType = 'image', expiresIn = 3600) => {
  try {
...
export const batchDeleteFiles = async (publicIds, resourceType = 'image') => {
  try {
