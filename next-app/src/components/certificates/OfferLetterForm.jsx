    ...
    <div className="bg-secondary-black rounded-lg shadow-md border border-dark-gray">
      <div className="p-6">
        ...
        {!showForm ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-5">
            <div>
              <label htmlFor="offerType" className="block text-sm font-medium text-gray-300 mb-2">
                Offer Type *
              </label>
              <select
                id="offerType"
            ...
            {formData.offerType === 'Internship' && (
              <div>
                <label htmlFor="payoutFrequency" className="block text-sm font-medium text-gray-300 mb-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-5">
            ...
            <div>
              <label htmlFor="salary" className="block text-sm font-medium text-gray-300 mb-2">
                {formData.offerType === 'Internship' ? 'Monthly Stipend (₹)' : 'Annual Salary (₹)'} *
              </label>
              <input
                type="number"
                id="salary"
                ...
                onChange={handleChange}
                required
                placeholder={formData.offerType === 'Internship' ? "Enter monthly stipend" : "Enter annual salary"}
                className="w-full px-3 py-2 bg-gray-800 text-white border border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-lime-400 focus:border-transparent"
              />
            </div>
          </div>
