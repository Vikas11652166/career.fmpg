    ...
    <div className="min-h-screen bg-[#fcfcfc] flex items-center justify-center px-6 py-20">
      <div className="max-w-xl w-full">
        <div className="text-center mb-16">
          ...
          <h2 className="text-5xl font-black tracking-tighter uppercase mb-4">Account <span className="text-lime-500">Initialization</span></h2>
          <p className="text-gray-400 font-bold uppercase tracking-widest text-xs">Create your professional profile</p>
        </div>
        
        <div className="bg-[#fcfcfc] p-12 rounded-[3rem] border border-gray-100 shadow-2xl">
          <form className="space-y-8" onSubmit={handleSubmit}>
            <div className="relative group">
              <label className="text-[10px] font-black uppercase tracking-[0.2em] text-gray-400 absolute -top-3 left-6 bg-[#fcfcfc] px-2 z-10">Full Name</label>
              <input
                type="text"
                name="name"
            ...
            <div className="relative group">
              <label className="text-[10px] font-black uppercase tracking-[0.2em] text-gray-400 absolute -top-3 left-6 bg-[#fcfcfc] px-2 z-10">Email Address</label>
              <input
                type="email"
                name="email"
                className="w-full px-8 py-5 bg-transparent border-2 border-gray-100 rounded-3xl outline-none focus:border-lime-500 transition-all font-bold text-gray-800"
            ...
            <div className="relative group">
              <label className="text-[10px] font-black uppercase tracking-[0.2em] text-gray-400 absolute -top-3 left-6 bg-[#fcfcfc] px-2 z-10">Contact Number</label>
              <input
                type="tel"
                name="phoneNumber"
                className="w-full px-8 py-5 bg-transparent border-2 border-gray-100 rounded-3xl outline-none focus:border-lime-500 transition-all font-bold text-gray-800"
            ...
            <div className="relative group">
              <label className="text-[10px] font-black uppercase tracking-[0.2em] text-gray-400 absolute -top-3 left-6 bg-[#fcfcfc] px-2 z-10">Access Cipher</label>
              <input
                type="password"
                name="password"
                className="w-full px-8 py-5 bg-transparent border-2 border-gray-100 rounded-3xl outline-none focus:border-lime-500 transition-all font-bold text-gray-800"
