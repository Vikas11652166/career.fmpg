...
const JobUpdateBanner = ({ applicationId, jobId, className = "", notifications = null }) => {
  ...
  useEffect(() => {
    if (Array.isArray(notifications)) {
      ...
      setRelatedNotifications(filteredNotifications);
      setIsVisible(filteredNotifications.length > 0 && !isDismissed);
      return;
    }
  ...
  }, [currentUser, applicationId, jobId, notifications, isDismissed]);
